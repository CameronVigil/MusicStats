...
export default function SplitFlapBoard({ items, showAlbumArt = true }) {
    const TILES_PER_ROW = 46;
    const ALBUM_TILES = 1;
        ...
        <div className="board-container">
            <div className="board-content">
                ...
                <div className="board-row">
                    ...
                    {/* Separator */}
                    <div className={"flap-tile separator", "titlespacing"}></div>
                ...
                {items.map((item, rowIndex) => {
                    ...
                    return (
                        <div key={rowIndex} className="board-row">
                            ...
                            {/* Title tiles */}
                            {[...titlePadded.slice(0, TITLE_TILES)].map((char, i) => (
                                <motion.div
